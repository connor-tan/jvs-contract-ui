import { Address, beginCell, Cell,type Contract, contractAddress, type ContractProvider, type Sender, SendMode, toNano, internal as internal_relaxed, storeMessageRelaxed } from '@ton/core';
...
export class JettonMinter implements Contract {
    ...
    */
    ...
    async getMasterAddress(provider: ContractProvider): Promise<Address> {
        const res = await provider.get('get_master_address', [])
        return res.stack.readAddress()
    }
}
